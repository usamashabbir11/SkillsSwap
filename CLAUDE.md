...
## Current Status
Phase 8 is complete and stable. No bugs. No UI breakage.

## Next Phase — Phase 9: Admin Panel & Profile Deletion
Goals:
1. Admin role — admin can view ALL user profiles and delete any user
2. User self-delete — logged in user can delete their own profile (like Facebook/Instagram)
